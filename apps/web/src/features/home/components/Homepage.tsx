...
// TODO add historical photographs as icon images to map theme categories or story categories
        ...
        <section className="py-24 md:py-32 bg-transparent" id="maps">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 bg-[#d1d35e] p-8 rounded-3xl inline-block w-full shadow-2xl">
              <h2 className="font-display text-4xl font-bold mb-4 text-black max-w-3xl mx-auto">
                Mapping Stories of Race, Migration, and Mobility in Hartford, Connecticut
              </h2>
              <p className="text-lg text-black max-w-5xl mx-auto">
                Hartford, Connecticut attracted three waves of internal and transnational migrations
                of African American, Puerto Rican, and West Indian communities that transformed the
                city&apos;s racial and ethnic landscape. These monumental shifts in mobilities unfolded
                in many other metropolitan areas in the United States like Chicago and Philadelphia,
                Harlem and San Francisco in the twentieth century. This project explores the history
                of migration, housing, settlement, community formation, and succession through the
                ...
                <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-10">
                  <div className="text-center text-white max-w-xl px-6">
                    ...
                    <p className="text-lg mb-8 opacity-90">
                      Explore Hartford&apos;s historical landscape through an interactive map. Discover
                      pivotal moments, landmarks, and individuals that shaped the city&apos;s trajectory.
                    </p>
                    <button
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="bg-white/80 backdrop-blur-md p-12 rounded-[2.5rem] border border-slate-100 shadow-xl">
              ...
              <p className="text-slate-600 mb-10 text-lg">
                Dive deeper into the archives or follow the thematic paths that connect our shared
                history.
              </p>
